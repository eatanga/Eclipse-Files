...
/**
 * Servlet implementation class addCarsForInventoryServlet
 */
@WebServlet("/addCarsForInventoryServlet")
public class addCarsForInventoryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addCarsForInventoryServlet() {
        super();
